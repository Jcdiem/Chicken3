...
class StartMenu:
    ...
    def switchScreen(self):
        self.transitionFrame = _newFrame('black')
...
class MainCamp:
    def __init__(self): #Creation of camp
        ...
        #     self.foregroundC = 'white'
        self.frameAry = [
            _newFrame(self.backgroundC),   #0: Main screen
            _newFrame(self.backgroundC)    #1: Locations screen
